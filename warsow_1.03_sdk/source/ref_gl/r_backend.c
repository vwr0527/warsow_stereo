...
{
	R_RenderMeshBufferWithClearOption(qtrue, mb, animData);
}

//McSchwartz
void R_RenderMeshBufferWithClearOption(qboolean clearArrays, const meshbuffer_t *mb, const rbackAnimData_t *animData )
{
	int i;
	shaderpass_t *pass;
	mfog_t *fog;
